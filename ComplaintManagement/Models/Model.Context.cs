...
namespace ComplaintManagement.Models
{
    ...
    public partial class DB_A6A061_complaintuserEntities : DbContext
    {
        ...
        public virtual DbSet<NumberSystem> NumberSystems { get; set; }
        public virtual DbSet<tbl_Staff> tbl_Staff { get; set; }
        public virtual DbSet<EmailTrack> EmailTracks { get; set; }
        public virtual DbSet<HR_Role> HR_Role { get; set; }
        public virtual DbSet<ErrorLogHistoryEntry> ErrorLogHistoryEntries { get; set; }
    }
}
