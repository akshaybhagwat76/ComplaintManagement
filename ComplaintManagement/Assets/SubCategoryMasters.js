...
function SearchSubCategories(searchText) {
    if (searchText !== null && searchText !== "") {
        location.href = "/SubCategory/SearchSubCategories?search=" + searchText;
    }
...
function performAction(id, isView) {
    let url = `/SubCategory/Edit?id=${id}&isView=${isView}`
    location.href = url;
}
function filterGrid() {
    ...
    if (fromDate == "" || toDate == "") {
        ...
        location.href = '/SubCategory/GetSubCategories?range=' + fromDate + ',' + toDate + '&currentPage=' + $("#hfCurrentPageIndex").val();
    }
}
function PagerClick(index) {
    ...
    if ($("#history").val() == undefined) {
        location.href = '/SubCategory/LoadSubCategories?currentPageIndex=' + $("#hfCurrentPageIndex").val() + '&range=' + range;
    }
    else {
        location.href = '/SubCategory/LoadHistorySubCategory?currentPageIndex=' + $("#hfCurrentPageIndex").val() + '&range=' + $("#history").val();
    }
