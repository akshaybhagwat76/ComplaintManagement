...
function searchLocation(searchText) {
    if (searchText !== null && searchText !== "") {
        location.href = "/Location/searchLocation?search=" + searchText;
    }
...
function performAction(id, isView) {
    let url = `/Location/Edit?id=${id}&isView=${isView}`
    location.href = url;
}
function filterGrid() {
    ...
    if (fromDate == "" || toDate == "") {
        ...
        location.href = '/Location/GetLocations?range=' + fromDate + ',' + toDate + '&currentPage=' + $("#hfCurrentPageIndex").val();
    }
}
function PagerClick(index) {
    ...
    location.href = '/Location/LoadLocation?currentPageIndex=' + $("#hfCurrentPageIndex").val() + '&range=' + range;
    }
    else {
        location.href = '/Location/LoadHistoryLocation?currentPageIndex=' + $("#hfCurrentPageIndex").val() + '&range=' + $("#history").val();
    }
