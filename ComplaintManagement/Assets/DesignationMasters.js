...
function performAction(id, isView) {
    let url = `/Designation/Edit?id=${id}&isView=${isView}`
    location.href = url;
}
function filterGrid() {
    ...
    if (fromDate == "" || toDate == "") {
        ...
        location.href = '/Designation/GetDesignation?range=' + fromDate + ',' + toDate + '&currentPage=' + $("#hfCurrentPageIndex").val();
    }
...
$("#btnUpload").on("click", function () {
    ...
    $.ajax({
        type: "POST",
        url: "/Designation/ImportDesignation",
