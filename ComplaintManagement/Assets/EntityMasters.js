...
function performAction(id, isView) {
    let url = `/Entity/Edit?id=${id}&isView=${isView}`
    location.href = url;
}
function filterGrid() {
    ...
    if (fromDate == "" || toDate == "") {
        ...
        location.href = '/Entity/GetEntity?range=' + fromDate + ',' + toDate + '&currentPage=' + $("#hfCurrentPageIndex").val();
    }
}
function PagerClick(index) {
    ...
    location.href = '/Entity/LoadEntity?currentPageIndex=' + $("#hfCurrentPageIndex").val() + '&range=' + range;
    }
    else {
        location.href = '/Entity/LoadHistoryEntity?currentPageIndex=' + $("#hfCurrentPageIndex").val() + '&range=' + $("#history").val();
    }
}
