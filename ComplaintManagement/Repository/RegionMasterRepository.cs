...
namespace ComplaintManagement.Repository
{
    public class RegionMasterRepository
    {
        ...
        public RegionMasterVM AddOrUpdate(RegionMasterVM RegionVM)
        {
                ...
                if (!string.IsNullOrEmpty(sid))
                {
                    using (var dbContextTransaction = db.Database.BeginTransaction())
                    {
                        ...
                        catch (Exception ex)
                        {
                            ...
                            new EmployeeComplaintHistoryRepository().ErrorLogHistory(null, ex.Message.ToString(), "Region Masters Create");
            ...
            {
                new EmployeeComplaintHistoryRepository().ErrorLogHistory(null, string.Join("\n", dve.EntityValidationErrors.SelectMany(x => x.ValidationErrors).Select(y => y.ErrorMessage)), "Region Masters Create");
